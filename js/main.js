...
$(document).ready(function(){
	...
	/*  video popups */
	$('.carousel').magnificPopup({type:'iframe'});	/* carousel modal*/
	...
	$('.tikka-modares-teachers-left').find('.tikka-modares-teachers-box').each(function(){
		$(this).mouseenter(function(){
			var scroll_top_item = $(this).offset().top - $('.tikka-modares-teachers-right').offset().top;
			$('.tikka-modares-teachers-right-box').css({marginTop:scroll_top_item})
		})
	})
